...
const DEST_TAGS = {
  ladakh: ['popular', 'mountains-hills', 'trek'],
  andaman: ['islands', 'beach', 'water-sports', 'popular'],
  spiti: ['mountains-hills', 'trek', 'hidden-gems', 'spiritual'],
  manali: ['popular', 'mountains-hills', 'trek'],
  kerala: ['popular', 'water-sports', 'wildlife'],
  meghalaya: ['waterfalls', 'trek', 'hidden-gems'],
  jaisalmer: ['heritage', 'popular'],
  goa: ['beach', 'popular', 'water-sports'],
  coorg: ['mountains-hills', 'hidden-gems', 'waterfalls'],
  sikkim: ['mountains-hills', 'trek', 'hidden-gems'],
  munnar: ['mountains-hills', 'popular', 'wildlife'],
  lakshadweep: ['islands', 'beach', 'water-sports', 'hidden-gems'],
};
...
const content = {
  ...
  destCategories: [
    ...
    { label: 'Mountains & Hills', slug: 'mountains-hills' },
    { label: 'Islands', slug: 'islands' },
    { label: 'Water Sports', slug: 'water-sports' },
    { label: 'Trek', slug: 'trek' },
    ...
    { label: 'Spiritual', slug: 'spiritual' },
  ],
  highlights,
  announcements,
  packages,
